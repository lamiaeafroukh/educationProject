              ...
              ?>
                    ...
                    <div class="col-12">
                      <div class="form-check">
                        ...
                        <label class="form-check-label" for="acceptTerms">I agree and accept the <a href="#">termes et conditions</a></label>
                        <div class="invalid-feedback">j'accepte.</div>
                      </div>
                    </div>
                    <div class="col-12">
                    ...
                    <div class="col-12">
                      <p class="small mb-0">vous avez déjà un compte? <a href="login.php">Log in</a></p>
                    </div>
                  </form>
